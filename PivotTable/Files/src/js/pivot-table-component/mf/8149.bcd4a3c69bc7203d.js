(self.webpackChunkapp_studio_enterprise_pivot_table=self.webpackChunkapp_studio_enterprise_pivot_table||[]).push([[8149,5834],{95834:(A,p,u)=>{u.r(p),u.d(p,{ArrayDataSource:()=>C,DataSource:()=>g,SelectionModel:()=>V,UniqueSelectionDispatcher:()=>a,_DisposeViewRepeaterStrategy:()=>w,_RecycleViewRepeaterStrategy:()=>y,_VIEW_REPEATER_STRATEGY:()=>T,getMultipleValuesInSingleSelectionError:()=>E,isDataSource:()=>S});var m=u(21322),f=u(94450);/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class g{}function S(c){return c&&typeof c.connect=="function"&&!(c instanceof m.ConnectableObservable)}/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class C extends g{constructor(e){super(),this._data=e}connect(){return(0,m.isObservable)(this._data)?this._data:(0,m.of)(this._data)}disconnect(){}}/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
