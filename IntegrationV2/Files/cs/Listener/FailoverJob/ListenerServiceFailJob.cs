namespace Terrasoft.Configuration
{
	...
	public class ListenerServiceFailJob: BaseFailoverJob<Mailbox>
	{
		...
		protected bool GetIsFeatureEnabledForAll(UserConnection userConnection, string code) {
			return FeatureUtilities.GetIsFeatureEnabledForAll(userConnection, code);
		}
