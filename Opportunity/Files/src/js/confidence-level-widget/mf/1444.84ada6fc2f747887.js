(self.webpackChunkapp_studio_enterprise_confidence_level_widget=self.webpackChunkapp_studio_enterprise_confidence_level_widget||[]).push([[1444,4904],{21444:(L,f,r)=>{r.r(f),r.d(f,{BreakpointObserver:()=>s,Breakpoints:()=>g,LayoutModule:()=>d,MediaMatcher:()=>i});var t=r(94450),M=r(3127),m=r(21322),o=r(27049),x=r(67202);/**
 * @license
