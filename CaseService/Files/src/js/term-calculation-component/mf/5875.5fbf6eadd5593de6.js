(self.webpackChunkapp_studio_enterprise_term_calculation=self.webpackChunkapp_studio_enterprise_term_calculation||[]).push([[5875,1232],{65875:(_,l,s)=>{s.r(l),s.d(l,{BidiModule:()=>o,DIR_DOCUMENT:()=>d,Dir:()=>i,Directionality:()=>n});var t=s(94450),c=s(31134);/**
 * @license
