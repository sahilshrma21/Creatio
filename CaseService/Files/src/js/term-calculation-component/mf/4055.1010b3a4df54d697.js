(self.webpackChunkapp_studio_enterprise_term_calculation=self.webpackChunkapp_studio_enterprise_term_calculation||[]).push([[4055],{74499:(h,l,r)=>{r.r(l),r.d(l,{FakeMatIconRegistry:()=>t,MatIconHarness:()=>u,MatIconTestingModule:()=>i});var o=r(8239),c=r(21936),s=r(94450),g=r(72856),_=r(21322);/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class u extends c.ComponentHarness{static with(e={}){return new c.HarnessPredicate(u,e).addOption("type",e.type,function(){var n=(0,o.Z)(function*(a,m){return(yield a.getType())===m});return function(a,m){return n.apply(this,arguments)}}()).addOption("name",e.name,(n,a)=>c.HarnessPredicate.stringMatches(n.getName(),a)).addOption("namespace",e.namespace,(n,a)=>c.HarnessPredicate.stringMatches(n.getNamespace(),a))}getType(){var e=this;return(0,o.Z)(function*(){return(yield(yield e.host()).getAttribute("data-mat-icon-type"))==="svg"?0:1})()}getName(){var e=this;return(0,o.Z)(function*(){const n=yield e.host(),a=yield n.getAttribute("data-mat-icon-name");return a||((yield e.getType())===1?n.text():null)})()}getNamespace(){var e=this;return(0,o.Z)(function*(){return(yield e.host()).getAttribute("data-mat-icon-namespace")})()}isInline(){var e=this;return(0,o.Z)(function*(){return(yield e.host()).hasClass("mat-icon-inline")})()}}u.hostSelector=".mat-icon";/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
