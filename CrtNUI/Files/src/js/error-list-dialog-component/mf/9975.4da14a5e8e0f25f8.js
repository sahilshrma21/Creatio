(self.webpackChunkapp_studio_enterprise_error_list_dialog=self.webpackChunkapp_studio_enterprise_error_list_dialog||[]).push([[9975,6321],{36321:(R,f,l)=>{l.r(f),l.d(f,{Platform:()=>n,PlatformModule:()=>r,_getEventTarget:()=>P,_getFocusedElementPierceShadowDom:()=>T,_getShadowRoot:()=>S,_isTestEnvironment:()=>D,_supportsShadowDom:()=>h,getRtlScrollAxisType:()=>I,getSupportedInputTypes:()=>w,normalizePassiveListenerOptions:()=>_,supportsPassiveEventListeners:()=>m,supportsScrollBehavior:()=>E});var o=l(94450),v=l(31134);/**
 * @license
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */let s;const p=["color","button","checkbox","date","datetime-local","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"];function w(){if(s)return s;if(typeof document!="object"||!document)return s=new Set(p),s;let e=document.createElement("input");return s=new Set(p.filter(t=>(e.setAttribute("type",t),e.type===t))),s}/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */let a;function m(){if(a==null&&typeof window<"u")try{window.addEventListener("test",null,Object.defineProperty({},"passive",{get:()=>a=!0}))}finally{a=a||!1}return a}function _(e){return m()?e:!!e.capture}/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */let d,i;function E(){if(i==null){if(typeof document!="object"||!document||typeof Element!="function"||!Element)return i=!1,i;if("scrollBehavior"in document.documentElement.style)i=!0;else{const e=Element.prototype.scrollTo;e?i=!/\{\s*\[native code\]\s*\}/.test(e.toString()):i=!1}}return i}function I(){if(typeof document!="object"||!document)return 0;if(d==null){const e=document.createElement("div"),t=e.style;e.dir="rtl",t.width="1px",t.overflow="auto",t.visibility="hidden",t.pointerEvents="none",t.position="absolute";const g=document.createElement("div"),y=g.style;y.width="2px",y.height="1px",e.appendChild(g),document.body.appendChild(e),d=0,e.scrollLeft===0&&(e.scrollLeft=1,d=e.scrollLeft===0?1:2),e.remove()}return d}/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
