(self.webpackChunkapp_studio_enterprise_schema_view=self.webpackChunkapp_studio_enterprise_schema_view||[]).push([[9975,6321],{36321:(R,f,d)=>{d.r(f),d.d(f,{Platform:()=>n,PlatformModule:()=>r,_getEventTarget:()=>P,_getFocusedElementPierceShadowDom:()=>T,_getShadowRoot:()=>S,_isTestEnvironment:()=>D,_supportsShadowDom:()=>h,getRtlScrollAxisType:()=>I,getSupportedInputTypes:()=>w,normalizePassiveListenerOptions:()=>E,supportsPassiveEventListeners:()=>m,supportsScrollBehavior:()=>_});var o=d(94450),v=d(31134);/**
 * @license
