(self.webpackChunkapp_studio_enterprise_duplicates_widget=self.webpackChunkapp_studio_enterprise_duplicates_widget||[]).push([[5834,8149],{95834:(A,g,u)=>{u.r(g),u.d(g,{ArrayDataSource:()=>w,DataSource:()=>p,SelectionModel:()=>V,UniqueSelectionDispatcher:()=>a,_DisposeViewRepeaterStrategy:()=>C,_RecycleViewRepeaterStrategy:()=>y,_VIEW_REPEATER_STRATEGY:()=>T,getMultipleValuesInSingleSelectionError:()=>E,isDataSource:()=>S});var m=u(21322),f=u(94450);/**
 * @license
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class w extends p{constructor(e){super(),this._data=e}connect(){return(0,m.isObservable)(this._data)?this._data:(0,m.of)(this._data)}disconnect(){}}/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
