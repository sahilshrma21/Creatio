(self.webpackChunkapp_studio_enterprise_duplicates_widget=self.webpackChunkapp_studio_enterprise_duplicates_widget||[]).push([[9975,6321],{36321:(R,f,d)=>{d.r(f),d.d(f,{Platform:()=>n,PlatformModule:()=>r,_getEventTarget:()=>P,_getFocusedElementPierceShadowDom:()=>T,_getShadowRoot:()=>S,_isTestEnvironment:()=>D,_supportsShadowDom:()=>h,getRtlScrollAxisType:()=>I,getSupportedInputTypes:()=>v,normalizePassiveListenerOptions:()=>E,supportsPassiveEventListeners:()=>m,supportsScrollBehavior:()=>_});var o=d(94450),w=d(31134);/**
 * @license
