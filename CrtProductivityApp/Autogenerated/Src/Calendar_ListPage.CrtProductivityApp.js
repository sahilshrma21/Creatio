	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_a43zlot_caption)#",
					"visible": true,
					"icon": "date",
					"clicked": {
			...
			{
				"operation": "insert",
				"name": "MenuItem_CalendarTimescale",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_CalendarTimescale_caption)#",
					"visible": true,
					"items": [],
					"icon": "date"
				},
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_xuy4qqm_caption)#",
					"visible": true,
					"clicked": {
				...
				"parentName": "MenuItem_CalendarTimescale",
				"propertyName": "items",
				"index": 0
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_q04k5ii_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.SetCalendarTimeScaleRequest",
						"params": {
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_x9mkc2k_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.SetCalendarTimeScaleRequest",
						"params": {
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_0z98vp4_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.SetCalendarTimeScaleRequest",
						"params": {
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_rp5jmta_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.SetCalendarTimeScaleRequest",
						"params": {
			...
			},
			{
				...
				"values": {
					...
					"config": {
						"caption": "#ResourceString(QuickFilter_svcbj7p_config_caption)#",
						"hint": "#ResourceString(QuickFilter_svcbj7p_config_hint)#",
						"icon": "date",
										...
										"args": [
											{
												...
												"config": {
													"caption": "#ResourceString(QuickFilter_xgh1gh9_caption)#",
													"defaultValue": true,
													"approachState": false
												}
											}
