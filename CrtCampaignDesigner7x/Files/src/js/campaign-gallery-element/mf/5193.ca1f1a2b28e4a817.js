 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class s extends e._MatSnackBarBase{constructor(t,n,k,d,A,v){super(t,n,k,d,A,v),this.simpleSnackBarComponent=l,this.snackBarContainerComponent=o,this.handsetCssClass="mat-snack-bar-handset"}}s.\u0275fac=function(t){return new(t||s)(a.\u0275\u0275inject(m.Overlay),a.\u0275\u0275inject(y.LiveAnnouncer),a.\u0275\u0275inject(a.Injector),a.\u0275\u0275inject(f.BreakpointObserver),a.\u0275\u0275inject(s,12),a.\u0275\u0275inject(e.MAT_SNACK_BAR_DEFAULT_OPTIONS))},s.\u0275prov=a.\u0275\u0275defineInjectable({token:s,factory:s.\u0275fac,providedIn:c}),function(){(typeof ngDevMode>"u"||ngDevMode)&&a.\u0275setClassMetadata(s,[{type:a.Injectable,args:[{providedIn:c}]}],function(){return[{type:m.Overlay},{type:y.LiveAnnouncer},{type:a.Injector},{type:f.BreakpointObserver},{type:s,decorators:[{type:a.Optional},{type:a.SkipSelf}]},{type:e.MatSnackBarConfig,decorators:[{type:a.Inject,args:[e.MAT_SNACK_BAR_DEFAULT_OPTIONS]}]}]},null)}();/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
