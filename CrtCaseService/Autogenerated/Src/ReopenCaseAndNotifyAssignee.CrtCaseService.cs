namespace Terrasoft.Configuration.CaseService
{
	...
	public class ReopenCaseAndNotifyAssignee
	{
		...
		public IncidentRegistrationFromEmailHelper RegistrationHelper {
			get => _registrationHelper ?? (_registrationHelper = ClassFactory.Get<IncidentRegistrationFromEmailHelper>(
		...
		private bool IsNeedToCreateNewCase(Entity caseEntity) {
			return Features.GetIsEnabled("CreateNewCaseInsteadOfReopenWhenRecipientChange") && IsRecipientChange(caseEntity);
		}
