define("AppFeatureState_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"columns": [
						{
							"id": "5efd82c9-5551-afb1-8832-7a30fd3aab26",
							"code": "PDS_Feature",
							"caption": "#ResourceString(PDS_Feature)#",
							"dataValueType": 10
						},
						{
							"id": "63b1e83b-e88e-ebb5-b67c-35ae51700e01",
							"code": "PDS_AdminUnit",
							"caption": "#ResourceString(PDS_AdminUnit)#",
							"dataValueType": 10
						},
						{
							"id": "149ffe9c-cfb6-2113-7b63-9e5dce5f123e",
							"code": "PDS_FeatureState",
							"caption": "#ResourceString(PDS_FeatureState)#",
							"dataValueType": 12,
							"width": 255
						}
					],
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "AppFeatureState",
					"layoutConfig": {
						"width": 328.125
					},
					"classes": [
