(self.webpackChunkapp_studio_enterprise_forecast=self.webpackChunkapp_studio_enterprise_forecast||[]).push([[8698,6341],{58698:(g,p,s)=>{s.r(p),s.d(p,{CdkAccordion:()=>i,CdkAccordionItem:()=>o,CdkAccordionModule:()=>n});var e=s(94450),u=s(60317),r=s(3127),l=s(21322);/**
 * @license
