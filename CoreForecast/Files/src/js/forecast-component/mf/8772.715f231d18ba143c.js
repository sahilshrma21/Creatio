(self.webpackChunkapp_studio_enterprise_forecast=self.webpackChunkapp_studio_enterprise_forecast||[]).push([[8772,9503],{38772:(O,_,c)=>{var f;c.r(_),c.d(_,{MAT_MOMENT_DATE_ADAPTER_OPTIONS:()=>M,MAT_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY:()=>A,MAT_MOMENT_DATE_FORMATS:()=>u,MatMomentDateModule:()=>d,MomentDateAdapter:()=>r,MomentDateModule:()=>s});var n=c(94450),o=c(66385),h=c(42378);/**
 * @license
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */const u={parse:{dateInput:"l"},display:{dateInput:"l",monthYearLabel:"MMM YYYY",dateA11yLabel:"LL",monthYearA11yLabel:"MMMM YYYY"}};/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class s{}s.\u0275fac=function(e){return new(e||s)},s.\u0275mod=n.\u0275\u0275defineNgModule({type:s}),s.\u0275inj=n.\u0275\u0275defineInjector({providers:[{provide:o.DateAdapter,useClass:r,deps:[o.MAT_DATE_LOCALE,M]}]}),function(){(typeof ngDevMode>"u"||ngDevMode)&&n.\u0275setClassMetadata(s,[{type:n.NgModule,args:[{providers:[{provide:o.DateAdapter,useClass:r,deps:[o.MAT_DATE_LOCALE,M]}]}]}],null,null)}();class d{}d.\u0275fac=function(e){return new(e||d)},d.\u0275mod=n.\u0275\u0275defineNgModule({type:d}),d.\u0275inj=n.\u0275\u0275defineInjector({providers:[{provide:o.MAT_DATE_FORMATS,useValue:u}],imports:[s]}),function(){(typeof ngDevMode>"u"||ngDevMode)&&n.\u0275setClassMetadata(d,[{type:n.NgModule,args:[{imports:[s],providers:[{provide:o.MAT_DATE_FORMATS,useValue:u}]}]}],null,null)}();/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
