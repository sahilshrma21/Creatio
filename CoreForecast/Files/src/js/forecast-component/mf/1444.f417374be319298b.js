(self.webpackChunkapp_studio_enterprise_forecast=self.webpackChunkapp_studio_enterprise_forecast||[]).push([[1444,4904],{21444:(L,f,r)=>{r.r(f),r.d(f,{BreakpointObserver:()=>d,Breakpoints:()=>g,LayoutModule:()=>s,MediaMatcher:()=>i});var t=r(94450),M=r(3127),m=r(21322),o=r(27049),x=r(67202);/**
 * @license
