 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */class s{}s.\u0275fac=function(e){return new(e||s)},s.\u0275mod=n.\u0275\u0275defineNgModule({type:s}),s.\u0275inj=n.\u0275\u0275defineInjector({providers:[{provide:o.DateAdapter,useClass:r,deps:[o.MAT_DATE_LOCALE,c]}]}),function(){(typeof ngDevMode>"u"||ngDevMode)&&n.\u0275setClassMetadata(s,[{type:n.NgModule,args:[{providers:[{provide:o.DateAdapter,useClass:r,deps:[o.MAT_DATE_LOCALE,c]}]}]}],null,null)}();class d{}d.\u0275fac=function(e){return new(e||d)},d.\u0275mod=n.\u0275\u0275defineNgModule({type:d}),d.\u0275inj=n.\u0275\u0275defineInjector({providers:[{provide:o.MAT_DATE_FORMATS,useValue:_}],imports:[s]}),function(){(typeof ngDevMode>"u"||ngDevMode)&&n.\u0275setClassMetadata(d,[{type:n.NgModule,args:[{imports:[s],providers:[{provide:o.MAT_DATE_FORMATS,useValue:_}]}]}],null,null)}();/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
